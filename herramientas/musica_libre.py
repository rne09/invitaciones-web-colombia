...
ESTILOS = {
    ...
    "cumple-vino":   (["Dm", "G", "C", "A"], 84, "piano", [0, 2, 1, 3, 2, 1, 3, 2], .3, 4),
    "cumple-disco":  (["Am", "Dm", "G", "C"], 124, "marimba", [0, 2, 0, 3, 1, 2, 0, 3], .15, 4),
    "coquette":      (["F", "Dm", "A#", "C"], 90, "cajita", [0, 1, 2, 3, 2, 1, 0, 2], .25, 5),
    "princesa":      (["D", "A", "G", "A"], 78, "cajita", [0, 2, 1, 3, 1, 2, 3, 1], .3, 5),
    "luna":          (["C", "Am", "F", "G"], 58, "cajita", [0, 1, 2, 1, 0, 2, 1, 2], .2, 5),
    "abejitas":      (["G", "C", "D", "G"], 112, "marimba", [0, 1, 2, 3, 2, 1, 2, 0], .1, 5),
}

# Premium Olivo (Boda (Premium))

Plantilla de muestra con datos ficticios. Apertura: **horizontal** · partículas: **petalos** · música propia sin derechos (`herramientas/musica_libre.py`, estilo `boda-floral`).
